...
return function ($app): void {
    ...
    $routeMap = [
        ...
        '/v1/business/users' => ROUTE . 'v1/UserRoute.php',
        '/v1/users' => ROUTE . 'v1/UserRoute.php',
        '/v1/business/admin' => ROUTE . 'v1/AdminRoute.php',
        '/v1/admin' => ROUTE . 'v1/AdminRoute.php',
        '/v1/business/analytics' => ROUTE . 'v1/AnalyticsRoute.php',
        '/v1/analytics' => ROUTE . 'v1/AnalyticsRoute.php',
        '/v1/business/settings' => ROUTE . 'v1/SettingsRoute.php',
        '/v1/settings' => ROUTE . 'v1/SettingsRoute.php',

        // Settings & Metadata
        '/v1/business/categories' => ROUTE . 'v1/CategoryRoute.php',
        '/v1/categories' => ROUTE . 'v1/CategoryRoute.php',
        '/v1/business/suppliers' => ROUTE . 'v1/SupplierRoute.php',
        '/v1/suppliers' => ROUTE . 'v1/SupplierRoute.php',
        '/v1/business/expense-categories' => ROUTE . 'v1/ExpenseCategoryRoute.php',
        '/v1/expense-categories' => ROUTE . 'v1/ExpenseCategoryRoute.php',
        '/v1/business/discounts' => ROUTE . 'v1/DiscountRoute.php',
        '/v1/discounts' => ROUTE . 'v1/DiscountRoute.php',
        '/v1/business/units-of-measure' => ROUTE . 'v1/UnitOfMeasureRoute.php',
        '/v1/units-of-measure' => ROUTE . 'v1/UnitOfMeasureRoute.php',

        // Inventory & Products
        '/v1/business/products' => ROUTE . 'v1/ProductRoute.php',
        '/v1/products' => ROUTE . 'v1/ProductRoute.php',
        '/v1/business/inventory' => ROUTE . 'v1/InventoryRoute.php',
        '/v1/inventory' => ROUTE . 'v1/InventoryRoute.php',
        '/v1/business/purchases' => ROUTE . 'v1/PurchaseRoute.php',
        ...
        '/v1/business/orders' => ROUTE . 'v1/OrderRoute.php',
        '/v1/orders' => ROUTE . 'v1/OrderRoute.php',
        '/v1/business/refunds' => ROUTE . 'v1/RefundRoute.php',
        '/v1/refunds' => ROUTE . 'v1/RefundRoute.php',

        // Expenses
        '/v1/business/expenses' => ROUTE . 'v1/ExpenseRoute.php',
        '/v1/expenses' => ROUTE . 'v1/ExpenseRoute.php',
        '/v1/business/expense-schedules' => ROUTE . 'v1/ExpenseScheduleRoute.php',
        '/v1/expense-schedules' => ROUTE . 'v1/ExpenseScheduleRoute.php',

        // System & Utils
        '/v1/business/transactions' => ROUTE . 'v1/TransactionRoute.php',
        '/v1/transactions' => ROUTE . 'v1/TransactionRoute.php',
        '/v1/business/audit-logs' => ROUTE . 'v1/AuditLogRoute.php',
        '/v1/audit-logs' => ROUTE . 'v1/AuditLogRoute.php',
        '/v1/business/notifications' => ROUTE . 'v1/NotificationRoute.php',
